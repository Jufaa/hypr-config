...
# Apply Image Wallpaper (FIXED FOR HYPRPAPER)
apply_image_wallpaper() {
  local image_path="$1"

  kill_wallpaper_for_image

  # iniciar hyprpaper si no está corriendo
  ...
  hyprctl hyprpaper wallpaper "$focused_monitor,$image_path"

  # refrescar UI
  sleep 1
  "$SCRIPTSDIR/Refresh.sh" 2>/dev/null
  sleep 1
